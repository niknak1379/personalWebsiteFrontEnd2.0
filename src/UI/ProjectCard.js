...
export default function ProjectCard(props) {
  ...
  return (
    <li className="Card">
      ...
      {projecdtDetailPageModal && (
        <ProjectDetailPage
          DialogStatus={projecdtDetailPageModal}
          DialogStatusFunc={setProjectDetailPage}
          CardData={props.CardData}
        />
      )}

      {projectEditPageModal && (
        <ProjectEditPage
          DialogStatus={projectEditPageModal}
          DialogStatusFunc={setProjectEditPage}
          CardData={props.CardData}
      ...
      <dialog ref={deleteDialogRef} className="deleteDialog">
        <div className="deleteDialogDiv">
          ...
          {!isLoading && error && <LoadingError></LoadingError>}
        </div>
      </dialog>

      {/* default projecet card elements(images, and descriptions) */}
      <img
        className="ProjectPicLoader"
        src={
