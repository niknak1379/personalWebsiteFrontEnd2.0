...
export default function Header() {
	...
	useEffect(() => {
		...
		console.log(
			"after init",
			themeBox.current.checked,
			themeBoxMobile.current.checked
		);
	}, []);
	/**
			...
			<div className="header">
				<a href={process.env.PUBLIC_URL} className="logo">
					<img
						...
						src="Assets/Header/logoLight.avif"
						alt="nikan logo"
					></img>
					<img
						className="logo darkLogo"
						src="Assets/Header/logoDark.avif"
						alt="nikan logo"
					></img>
				</a>
				...
				<div className="contactButtonWraper">
					...
					<button className="contactButton" onClick={openContactMe}>
						Lets Talk
					</button>
				</div>
