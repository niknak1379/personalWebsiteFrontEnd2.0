...
export default function ContactForm(props){
    ...
    async function submitForm() {
        ...
        try{
            ...
            if (!response.ok) {
                throw new Error("Connection established but unexpected answer recieved")
            }
    ...
    return(
        <dialog ref={dialog} className = "contactMeDialog" id="contactMe" aria-modal="true">
            <div id="dialogHeader">
                <a href = "">Nikan.</a>
                <button id="closeButton" onClick={closeForm} aria-label="close">X</button>
            </div>
            ...
            <form ref={formRef} id="contactMeForm">
                ...
                <label htmlFor="Name">
                    Name & Last Name
                    <input ref={nameRef} name="Name" id="Name" placeholder="John Doe" required></input>
                </label>
                
                <label htmlFor="Email">
                    Email
                    <input ref={emailRef} onBlur={changeEmailCSS} type="email" id="Email" placeholder="example@gmail.com" required></input>
                    <span id="emailSpan">Invalid Email</span>
                </label>
                
                <label htmlFor="Message">
                    Message
                    <textarea ref={messageRef} name="Message" id="Message" required placeholder="Enter your message here..."></textarea>
                </label>
                </div>
                ...
                <div id="buttonWrap" className="buttonWrap">
                    <div className="g-recaptcha" data-sitekey="6LcsvdwpAAAAANF3dMzaR0u2rzFaK1cygq_x969E"></div>
