...
export default function Login() {
	...
	const { accessToken, setToken, trust, setTrust, baseURL } =
	...
	useEffect(() => localStorage.setItem("trust", trust), [trust]);
	...
	return (
		<>
			{accessToken && <Navigate to="/" state={{ from: location }} replace />}
			{accessToken == null && (
				<form className="loginForm Background" ref={loginRef}>
					...
					>
						<img
							alt="google icon"
							src={process.env.PUBLIC_URL + "/Assets/googleIcon.svg"}
						/>
