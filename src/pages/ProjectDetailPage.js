        ...
        <dialog className='projectDetailPage' ref={dialogRef}>
            ...
            {!isLoading && !error && (projData != null) &&
                ...
                <span>Project Tags:</span>
                    ...
                    <ul className="linksList">
                        <li>
                            <span>Deployment URL:</span> <a target='_blank' href={props.CardData.deploymentURL}><img src={process.env.PUBLIC_URL + '/Assets/App/Cards/Icons/link.png'}></img></a>
                        </li>
                        <li>
                            Repository: <a target='_blank' href={props.CardData.githubURL}><img src={process.env.PUBLIC_URL + '/Assets/App/Cards/Icons/github.svg'}></img></a>
                        </li>
                        <li>
                            Notes and Documentation: &nbsp; &nbsp; <a target='_blank' href={projData.obsidianURL}><img src={process.env.PUBLIC_URL + '/Assets/App/Cards/Icons/obsidian.svg'}></img></a>
                        </li>
                    </ul>
                </div>
            }
